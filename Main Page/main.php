...
<body>
  ...
  <div class="dropdown-content">
    ...
    <a href="../User/Teacher.php">Teacher Panel</a>
		...
		<b style="color: white;">Notice	<marquee><?php 
...
$result = mysqli_query($conn,$sql);
 ?>
	...
	<?php } ?>
			...
			<div class="features">
				<button class="btn btn-light">Building</button>
				<button class="btn btn-light">Branch</button>
				<button class="btn btn-light"><a href="../User/Notice_index.php">Notice</button></a>
