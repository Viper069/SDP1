...
$sql = "SELECT * FROM student ORDER BY Class";
...
<h1 style="color: white;"><strong>Student list</strong></h1>
	<table class="table table-striped" style="background-color: initial; color: white;">
		<tr>
			<th>Roll</th>
			<th>Name</th>
			<th>Class</th>
			...
			<td>
				<a href="view.php?id=<?php echo $row['Roll']; ?>" class= "btn btn-info" >Full_details</a>
